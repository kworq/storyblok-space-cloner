...
import fs from "fs";
export async function copyComponents(clients, NOW, toDisk = false, toDiskPath, fromDisk, created_count = 0, updated_count = 0) {
    ...
    const t_response = await targetClient.get(`/spaces/${targetSpaceId}/components/`, {});
